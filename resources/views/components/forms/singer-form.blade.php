{{-- This component should be used both to ctreate a new singer and to update a singer that already exist --}}
<form class="frm-cnt" method="post" action="{{ route($action) }}">
    @csrf
